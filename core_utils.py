...
import random
from remod.model import _finite_token
...
def parse_analyze_args(args: list[str] | None = None):
    ...
    parser.add_argument(
        ...
        type=_finite_token,
        default=20.0,
        help="Radial profile step in native SWC coordinate units (default: 20)",
    )
...
def parse_edit_args(args: list[str] | None = None):
    ...
    parser.add_argument("--amount", type=_finite_token, help="Structural action amount")
    parser.add_argument(
        "--radius-unit",
        dest="radius_unit",
        default="percent",
    ...
    parser.add_argument("--radius-change", type=_finite_token, help="Radius adjustment")
    parser.add_argument(
    ...
    if options.who != "manual" and options.manual_segments.lower() != "none":
        parser.error("--manual-segments is used only with --who manual")
